            ...
            <div className="nt-r-login" style={{ backgroundImage: `url(http://ig.com.my/wp-content/uploads/2017/11/profile-background.jpg)` }}>
                <div className="nt-log-card" style={{ backgroundImage: `url(http://ig.com.my/wp-content/uploads/2017/11/profile-background.jpg)` }}>
                    ...
                    <div className="nt-login">
                        <h1>I C A F</h1>
                        <p className="nt-log-head">Workshop Coordinator | SignUp</p>    
                    </div>    
                    ...
                    >
                        <div className="nt-log-form">
                            <div className="nt-formitem">
                                ...
                                <input type="text" name="name" className="nt-input" placeholder="Your Name" 
                                    // value={this.state.name} onChange={this.handleChange} required
                                />
                            </div>
                            <div className="nt-formitem">
                                {/* <label className="nt-lable" htmlFor="">User Name</label><br /> */}
                                <input type="text" name="studyField" className="nt-input" placeholder="your Feild of study" 
                                    // value={this.state.studyField} onChange={this.handleChange} required
                                />
                            </div>
                            <div className="nt-formitem">
                                {/* <label className="nt-lable" htmlFor="">User Name</label><br /> */}
                                <input type="email" name="email" className="nt-input" placeholder="your email" 
                                    // value={this.state.email} onChange={this.handleChange} required
                                />
                            </div>
                            <div className="nt-formitem">
                                {/* <label className="nt-lable" htmlFor="">User Name</label><br /> */}
                                <input type="password" name="password" className="nt-input" placeholder="Your Password" 
                                    // value={this.state.password} onChange={this.handleChange} required
                                />
                            </div>
                            <div className="nt-formitem">
                                {/* <label className="nt-lable" htmlFor="">User Name</label><br /> */}
                                <input type="password" name="confPassword" className="nt-input" placeholder="Confirm Password" 
